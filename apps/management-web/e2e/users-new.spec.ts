...
/**
 * Permission: usersCrud create required; else redirect /users. Actor matrix: unauthenticated →
 * login; super-admin and admin with users create → form; admin without users create →
 * redirect /users.
 */

test.describe('This suite verifies the management users-new-page: unauthenticated redirect, permitted role sees add-user-form, create success and validation, Cancel→list.', () => {
