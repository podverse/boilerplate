...
export default defineConfig({
  ...
  webServer: [
    ...
    {
      command:
        'PORT=4112 MANAGEMENT_API_BACKEND_URL=http://localhost:4110 NEXT_PUBLIC_MANAGEMENT_API_URL=/api/management NEXT_PUBLIC_WEB_APP_URL=http://localhost:4012 npm run build -w @boilerplate/management-web && NODE_OPTIONS="--disable-warning=DEP0060" PORT=4112 MANAGEMENT_API_BACKEND_URL=http://localhost:4110 NEXT_PUBLIC_MANAGEMENT_API_URL=/api/management NEXT_PUBLIC_WEB_APP_URL=http://localhost:4012 npm run start -w @boilerplate/management-web',
      port: 4112,
      cwd: '../..',
      reuseExistingServer: false,
      timeout: 420_000,
