...
/** Signup-page: unauthenticated only. Validation (duplicate email, weak password, invalid email); valid submit→redirect to login or dashboard. */

test.describe('This suite verifies the web signup-page: form visible, duplicate-email validation, invalid-email validation, weak-password validation, valid signup→success (redirect), empty form→submit disabled, and log-in link→login-page.', () => {
