...
/**
 * Permission: list shows buckets the user owns or has bucket_admin access to. Actor matrix:
 * unauthenticated → login; owner and admins see list (filtered by access); non-admin sees list
 * (only buckets they have access to, or empty).
 */
