...
/** Forgot-password-page: form visible, invalid/empty email validation, valid email→success message, log-in link. */

test.describe('This suite verifies the web forgot-password-page: form visible, validation for invalid or empty email, success message after valid submit, and log-in link to login-page.', () => {
