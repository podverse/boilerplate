...
- **Permission actor matrix:** Add management roles: super-admin (full CRUD), admin with bucketAdminsCrud, admin without → not found; list→edit and Cancel→list already present for super-admin; add Save→list for editable admin row if applicable.
