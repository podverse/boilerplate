...
- **One-time setup:** From repo root run `make test_deps` to start Postgres and Valkey, create test DBs (`boilerplate_test`, `boilerplate_management_test`), and (for E2E) start Mailpit. See `make help_test` for instructions.
