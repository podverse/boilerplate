...
If you add or change dependencies later, run `./scripts/update-lockfile-linux.sh` (requires Docker) and commit the updated `package-lock.json` so CI stays green. See [Lockfile (Linux)](development/LOCKFILE-LINUX.md).
